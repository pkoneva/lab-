...
//	}
//	
//	/*void PrintMatr(const Matrix& that) {
...
//		}
//	}*/
//	/*Matrix SetElem(const Matrix& that) {
//		for (int i = 0; i < that.n; i++) 
//			for (int j = 0; j < that.n; j++)
//				cin >> that.matr[i][j];
//		return that;
//	}*//*Matrix Transpose(const Matrix& that) {
//		int rem;
//		for (int i = 0; i < that.n; i++) {
//			for (int j = i+1; j < that.n; j++) {
//				rem = that.matr[i][j];
//				that.matr[i][j] = that.matr[j][i];
//				that.matr[j][i] = rem;
//
//			}
//		}
...
//	/*for (int i = 0; i < N; i++) {
//		for (int j = 0; j < N; j++)
//			fout << Res.GetElem(i, j) << " ";
//		fout << endl;
//	}*/
//	fin.close();
//	fout.close();
//	A.~Matrix(); B.~Matrix(); C.~Matrix(); D.~Matrix(); K.~Matrix(); Res.~Matrix();
//	return 0;
//}
#include <fstream>
#include <iostream>
